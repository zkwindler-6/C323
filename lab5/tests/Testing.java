...
public class Testing {
    ...
    public void BSTlargestNode() {
        ...
        for (Integer key : a)
            bst.insert(key);
        assert a.length == bst.n;
        assert 9 == bst.largestNode(bst.root).data;
        assert 2 == bst.largestNode(bst.root.left).data;
        assert 9 == bst.largestNode(bst.root.right).data;
        assert 8 == bst.largestNode(bst.root.right.left).data;
    }
