...
public class PriorityQueue<E> {
    ...
    Comparator<E> comp;
    int n;
    HashMap<E, Integer> map = new HashMap<>(1069);
    ...
    //toString method for PriorityQueue
    public String toString() {
        if (isEmpty())
            return "[]";
        StringBuilder sb = new StringBuilder("[").append(this.heap[0]);
        for (int i = 1; i < size(); i++) {
            sb.append(", ").append(this.heap[i]);
        }
