...
public class GUI extends JFrame {
  ...
  /**
   * Returns the similarity of the two images using however many bits
   * per channel appear on bitSelector. Results are memoized to speed
   * the process.
   */
  ...
  private double similarity() {
    ...
    double sim = Util.similarity(leftImage, rightImage, bitsPerChannel);
  ...
  /**
   * Returns a black and white version of the given image, where
   * pixels matching color are white.
   */
